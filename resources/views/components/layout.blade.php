...
<section class="px-6 py-8">
    <nav class="md:flex md:justify-between md:items-center">
        <div class="flex">
            ...
            <a href="/posts" class="ml-6">Posts</a>
            <a href="/admin/post/create" class="ml-6">Create new post</a>
        </div>
        ...
        <div class="mt-8 md:mt-0 flex items-center">
            ...
            @auth
                ...
                <form class="text-xs bold text-blue-300 ml-2"
                      action="/logout"
                      method="post"
                        >
                    @csrf

                    <button class="font-semibold" type="submit">Log out</button>
                </form>
            @else
